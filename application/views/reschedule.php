...
<div class="container body-content" id="dateandtime" >
    <div class="row">
       ...
       <div class="col-sm-12 col-md-12 left-content">
           ...
           <br/>
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 privacy-note" style="text-align:center;">
					...
					<button class="button" role="div" id="bookApp" type="submit" style="width:300px;margin:0 auto!important;border:none;">Reschedule This Appointment</button>    
			</div>
			 </form>
             </div>
<!-- left column / left side -->
    ...
    <script>
	  ...
	  //Book Appointment function on Submit
        ...
        function bookAppointment(objRequest) {
            ...
            $.ajax({
      		  url: "<?php echo base_url();?>ajaxHandler/rescheduleAppointment",
      			type: 'post',
      			dataType: 'json',
      		    data: postData,	  
      		  beforeSend: function( xhr ) {
